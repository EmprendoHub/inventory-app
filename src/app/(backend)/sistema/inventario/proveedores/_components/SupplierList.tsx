...
import { supplierAndProductType } from "@/types/categories";

export const columns: ColumnDef<supplierAndProductType>[] = [
  {
    accessorKey: "name",
    header: ({ column }) => {
      return (
  ...
  {
    accessorKey: "phone",
    header: () => <div className="text-left text-xs maxsm:hidden">Tel.</div>,
    cell: ({ row }) => (
...
export function SupplierList({
  ...
  suppliers: supplierAndProductType[];
}) {
  ...
  const table = useReactTable<supplierAndProductType>({
    data: suppliers,
    columns,
    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        <div className="flex-1 text-sm text-muted-foreground">
          ...
          {table.getFilteredRowModel().rows.length} proveedores(s)
          seleccionada(s).
        </div>
