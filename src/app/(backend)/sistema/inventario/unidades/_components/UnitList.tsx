...
import { unitAndProductType } from "@/types/categories";

export const columns: ColumnDef<unitAndProductType>[] = [
  {
    accessorKey: "title",
    header: ({ column }) => {
      return (
...
export function UnitList({ units }: { units: unitAndProductType[] }) {
  ...
  const table = useReactTable<unitAndProductType>({
    data: units,
    columns,
