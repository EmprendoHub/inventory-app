    ...
    <div className="h-24 flex flex-col justify-between shadow-md bg-secondary  mb-4 p-3">
      <div className="flex items-center justify-start rounded-md px-2 gap-3 ">
        ...
        <div className="flex flex-col">
          <p className="text-xl leading-none">Hola, Bienvenido</p>
          <span className="text-sm text-muted">Salvador S.</span>
        </div>
      </div>
      {/* Navigation */}
      <nav className="sticky top-0 z-10 h-12 p-2 rounded-md">
        <ul className="flex text-sm text-gray-500 items-center gap-6">
          <li
            className={` ${
