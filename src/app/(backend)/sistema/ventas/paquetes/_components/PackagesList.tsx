...
import { packagesType } from "@/types/sales";

export const columns: ColumnDef<packagesType>[] = [
  {
    accessorKey: "title",
    header: ({ column }) => {
      return (
...
export function PackagesList({ packages }: { packages: packagesType[] }) {
  ...
  const table = useReactTable<packagesType>({
    data: packages,
    columns,
