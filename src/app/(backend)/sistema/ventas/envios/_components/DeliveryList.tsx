...
import { deliveriesAndProductType } from "@/types/sales";

export const columns: ColumnDef<deliveriesAndProductType>[] = [
  {
    accessorKey: "title",
    header: ({ column }) => {
      return (
...
export function DeliveryList({
  ...
  deliveries: deliveriesAndProductType[];
}) {
  ...
  const table = useReactTable<deliveriesAndProductType>({
    data: deliveries,
    columns,
