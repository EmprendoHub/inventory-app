...
import { receiptsAndProductType } from "@/types/sales";

export const columns: ColumnDef<receiptsAndProductType>[] = [
  {
    accessorKey: "title",
    header: ({ column }) => {
      return (
...
export function ReceiptList({
  ...
  receipts: receiptsAndProductType[];
}) {
  ...
  const table = useReactTable<receiptsAndProductType>({
    data: receipts,
    columns,
