...
const sliders = [
  {
    preTitle: "Maestría en carpintería",
    title: "Muebles Elegantes",
    titleTwo: " para Cada Espacio de Tu Hogar",
    text: "Descubre muebles fabricados con atención al detalle y materiales de alta calidad. Diseños que combinan funcionalidad y estilo para transformar tu hogar.",
  ...
  },
  {
    ...
    text: "Relájate en muebles diseñados para durar. Nuestra línea de sofás y sillones combina comodidad suprema con diseños modernos para todos los gustos.",
    btnText: "Ver sofás disponibles",
    btnPath: "/es/#productos",
  ...
  },
  {
    ...
    titleTwo: " para Reuniones Inolvidables",
    text: "Convierte tus comidas en momentos especiales con nuestros comedores modernos y versátiles. Elige el estilo que mejor se adapte a tu hogar.",
    btnText: "Encuentra el tuyo",
    btnPath: "/es/#productos",
    imgPath: "/images/slider3.webp",
  },
  {
    preTitle: "Ambientes únicos",
    title: "Recámaras",
    titleTwo: " que Invitan al Descanso",
    text: "Crea un ambiente acogedor y relajante con nuestras recámaras. Diseños exclusivos que combinan confort, estilo y durabilidad.",
    btnText: "Descubre nuestras recámaras",
    btnPath: "/es/#productos",
